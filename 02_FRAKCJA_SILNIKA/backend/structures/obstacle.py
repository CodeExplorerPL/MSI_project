...
class Obstacle(ABC):
    ...
    def is_destructible(self) -> bool:
        return self.obstacle_type.value['destructible']
    
    @property
    def is_see_through(self) -> bool:
        return self.obstacle_type.value['see_through']
...
class AntiTankSpike(Obstacle):
    ...
    obstacle_type: ObstacleType = field(default=ObstacleType.ANTI_TANK_SPIKE, init=False)
